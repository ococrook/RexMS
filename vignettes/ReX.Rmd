...
As package developers, we try to explain clearl
y how to use our packages and in which order to use the functions.
...
may have lost a large number of peptidesif you had lots of missing values.
At this point it will be useful to check the redundancy of the data. The
following code chunk will perform heatmap of the peptide map.
